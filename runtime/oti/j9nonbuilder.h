...
typedef struct J9InternalVMFunctions {
	...
	void (*freeContinuation)(struct J9VMThread *currentThread, j9object_t continuationObject, BOOLEAN isGlobal);
	void (*recycleContinuation)(struct J9JavaVM *vm, struct J9VMThread *vmThread, struct J9VMContinuation *continuation, BOOLEAN isGlobal);
