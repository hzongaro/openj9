...
TR_ResolvedJ9Method::TR_ResolvedJ9Method(TR_OpaqueMethodBlock * aMethod, TR_FrontEnd * fe, TR_Memory * trMemory, TR_ResolvedMethod * owner, uint32_t vTableSlot)
   ...
   struct X
      ...
      /**
       * Constructor for recognized method specifying only the kind of
       * method.  Typically used to mark an unknown placeholder entry.
       */
      ...
      /**
       * Constructor for recognized method specifying only the kind of
       * method and its name.  The signature is considered to be a wildcard,
       * so this constructor is used to match methods with any signature.
       */
      ...
      /**
       * Constructor for recognized method specifying kind of method, its
      ...
      /**
       * Constructor for recognized method that is expected to be native,
       * specifying the kind of method, its name, and the range of Java
       * versions for which it is expected to native.  If only the lower
       * bound is specified, the range is considered to be unbounded.  The
       * signature is considered to be a wildcard, so this constructor is
       * used to match methods with any signature.
       */
      ...
      /**
       * Constructor for recognized method that is expected to be native,
       * specifying the kind of method, its name and its signature, and the
       * range of Java versions for which it is expected to native.  If only
       * the lower bound is specified, the range is considered to be unbounded.
       */
   ...
   static X JITHelperMethods[] =
      ...
      X(TR::com_ibm_jit_JITHelpers_getJ9ClassFromClass32,                    "getJ9ClassFromClass32", "(Ljava/lang/Class;)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getBackfillOffsetFromJ9Class32,           "getBackfillOffsetFromJ9Class32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getRomClassFromJ9Class32,                 "getRomClassFromJ9Class32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getArrayShapeFromRomClass32,              "getArrayShapeFromRomClass32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getSuperClassesFromJ9Class32,             "getSuperClassesFromJ9Class32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getClassDepthAndFlagsFromJ9Class32,       "getClassDepthAndFlagsFromJ9Class32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getClassFlagsFromJ9Class32,               "getClassFlagsFromJ9Class32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getModifiersFromRomClass32,               "getModifiersFromRomClass32", "(I)I", AllPastJavaVer),
      X(TR::com_ibm_jit_JITHelpers_getClassFromJ9Class32,                    "getClassFromJ9Class32", "(I)Ljava/lang/Class;", AllPastJavaVer),
