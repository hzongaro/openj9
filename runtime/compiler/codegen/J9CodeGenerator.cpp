...
J9::CodeGenerator::lowerArrayStoreCHK(TR::Node *node, TR::TreeTop *tt)
   ...
   if (!sourceChild->isNonNull())
      ...
      TR::TreeTop *anchoredSourceTT = TR::TreeTop::create(self()->comp(), tt->getPrevTreeTop(), TR::Node::create(TR::treetop, 1, sourceChild));
      TR::TreeTop *anchoredArrayTT = TR::TreeTop::create(self()->comp(), anchoredSourceTT, TR::Node::create(TR::treetop, 1, destChild));
